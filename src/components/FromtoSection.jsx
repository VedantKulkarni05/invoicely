  ...
  return (
    <section className="bg-zinc-900 p-6 rounded-xl border border-zinc-700">
      ...
      <div className="flex justify-end ">
        ...
        >
          <span className="absolute inset-0 bg-[#ffffff] rounded-full transition-all duration-300 group-hover:translate-x-1 group-hover:-translate-y-1"></span>

          <div className="relative bg-[#e27b7c] border-2 border-[#e27b7c] text-white rounded-full w-full h-full flex items-center justify-center gap-1 px-2">
